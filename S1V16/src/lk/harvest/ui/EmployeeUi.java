...
public class EmployeeUi extends JFrame{
    ...
    public EmployeeUi(){ 
        ...
        txtName.addKeyListener( new KeyAdapter(){public void keyReleased(KeyEvent e){Validation.txtNameKR( e, oldEmployee, employee, txtName );}});
        txtNic.addKeyListener( new KeyAdapter(){ public void keyReleased(KeyEvent e){ Validation.txtNicKR( e, oldEmployee, employee, txtNic ); } } );
        txtEmail.addKeyListener( new KeyAdapter(){ public void keyReleased(KeyEvent e){ Validation.txtEmailKR( e, oldEmployee, employee, txtEmail ); } } );
        txtMobile.addKeyListener( new KeyAdapter(){ public void keyReleased(KeyEvent e){ Validation.txtMobileKR( e, oldEmployee, employee, txtMobile ); } } );
