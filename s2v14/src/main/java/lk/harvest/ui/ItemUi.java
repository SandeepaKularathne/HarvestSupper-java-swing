...
public class  ItemUi extends JFrame {
    ...
    public void fillForm(Item item){
        ...
        txtPricePurchase.setText(String.valueOf(item.getPricePurchase()));
        txtPriceSale.setText(String.valueOf(item.getPriceSale()));
        ...
        dteDoIntroduced.setDate( new java.util.Date(item.getDoIntroduced().toEpochDay() * 1000*3600*24));
    ...
    //Icon use
    Icon iconSerchBlack = new ImageIcon("src/main/resources/search.png");
    Icon iconSerchRed = new ImageIcon("src/main/resources/search1.png");
    Icon iconAddBlack = new ImageIcon("src/main/resources/Users-Add-User-icon.png");
    Icon iconAddRed= new ImageIcon("src/main/resources/add-user-icon.png");
    Icon iconClearRed= new ImageIcon("src/main/resources/clear-red.png");
    Icon iconClearBlack= new ImageIcon("src/main/resources/clear-black.png");
    Icon iconDeleteRed= new ImageIcon("src/main/resources/delete-red.png");
    Icon iconDeleteBlack= new ImageIcon("src/main/resources/delete-black.png");
    Icon iconUpdateRed= new ImageIcon("src/main/resources/update-red.png");
    Icon iconUpdateBlack= new ImageIcon("src/main/resources/update-black.png");
